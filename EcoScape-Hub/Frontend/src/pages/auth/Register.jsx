...
const Register = () => {
  ...
  return (
    <div className="h-screen bg-white flex overflow-hidden">
        ...
        >
          <div className="max-w-lg">
            ...
            <p className="text-xl text-green-100 mb-12 leading-relaxed">
              Join thousands of eco-conscious homeowners creating beautiful,
              sustainable landscapes that benefit both people and the planet.
            </p>
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-green-200 text-sm">
                    Free personalized garden design consultations
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-green-200 text-sm">
                    Connect with 15,000+ eco-gardening enthusiasts
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-green-200 text-sm">
                    Access to exclusive sustainability guides & tools
                  </p>
                </div>
              </motion.div>
            </div>
            ...
            <div className="flex items-center gap-8 mt-8 pt-8 border-t border-white/20">
              <div className="text-center">
                ...
                <div className="text-sm text-green-200">Happy Members</div>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-green-200">Projects Completed</div>
              </div>
            </div>
          </div>
        </motion.div>
      ...
      <div className="flex-2 w-full flex items-center flex-col  bg-gray-50 ">
        <div className="flex-1 w-full overflow-y-auto py-8 px-16 ">
          <div className="flex items-center justify-center min-h-full ">
            ...
            >
              <div className="bg-white rounded-3xl shadow-2xl p-8 border border-gray-100 my-4">
                {/* Header */}
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="relative">
                      ...
                      <FaUser className="absolute left-4 top-12 transform -translate-y-1/2 text-gray-400 text-sm" />
                      <input
                        type="text"
                        name="firstName"
                        ...
                        required
                        className="w-full pl-12 pr-4 py-3 rounded-xl border border-gray-200 focus:ring-1 focus:ring-green-500 focus:border-transparent outline-none transition-all duration-300 text-sm bg-gray-50 focus:bg-white"
                      />
                    </div>
                    <div className="relative">
                      <label className="block text-sm font-medium text-gray-700 mb-2">
                      ...
                      <input
                        ...
                        required
                        className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-1 focus:ring-green-500 focus:border-transparent outline-none transition-all duration-300 text-sm bg-gray-50 focus:bg-white"
                      />
                    </div>
                  </div>
                  ...
                  <div className="relative">
                    ...
                    <FaPhone className="absolute left-4 top-12 transform -translate-y-1/2 text-gray-400 text-sm" />
                    <input
                      type="tel"
                      name="phone"
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      className="w-full pl-12 pr-12 py-3 rounded-xl border border-gray-200 focus:ring-1 focus:ring-green-500 focus:border-transparent outline-none transition-all duration-300 text-sm bg-gray-50 focus:bg-white"
                    />
                    <button
                      type="button"
                  ...
                  <div className="space-y-3">
                    <label className="flex items-start gap-3 text-sm text-gray-700 cursor-pointer">
                      <input
                        ...
                        onChange={handleInputChange}
                        className="mt-0.5 h-4 w-4 accent-emerald-400 text-green-600 focus:ring-green-500 border-gray-300 rounded transition-colors duration-200"
                      />
                      <span>
                        I agree to the{" "}
                        <Link
                    ...
                    <label className="flex items-start gap-3 text-sm text-gray-700 cursor-pointer">
                      <input
                        ...
                        className="mt-0.5 h-4 w-4 accent-emerald-400 text-green-600 focus:ring-green-500 border-gray-300 rounded transition-colors duration-200"
                      />
                      <span>Send me sustainability tips and updates</span>
                    </label>
                  </div>
